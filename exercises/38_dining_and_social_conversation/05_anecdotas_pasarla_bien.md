...
<!-- SOLUTION
armamos un gran plan y la pasamos muy bien celebrando
-->

<!-- ALTERNATIVES
armamos un gran plan y nos la pasamos en grande celebrando
armamos un planazo y lo pasamos genial celebrando
armamos un gran plan y lo pasamos muy bien celebrando
organizamos un gran plan y la pasamos muy bien celebrando
-->

<!-- DIAGNOSTIC_RULES
pattern: "tuvimos un buen tiempo" | code: "E3805" | message: "'To have a good time' is 'pasarla bien' or 'pasárselo bien', never literal calque 'tener un buen tiempo'."
-->

<!-- HINTS
Tier 1: Translate 'we put together a great plan and had a very good time celebrating'.
Tier 2: 'armamos' + 'un' + 'gran' + 'plan' + 'y' + 'la' + 'pasamos' + 'muy' + 'bien' + 'celebrando'.
Tier 3: Solution: 'armamos un gran plan y la pasamos muy bien celebrando'.
-->
