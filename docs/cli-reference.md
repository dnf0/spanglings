...
**Topics:** `ser-estar`, `past-tenses`, `subjunctive`, `por-para`, `pronouns`, `accidental-se`, `accents`, `tech`, `business`, `false-friends`, `voseo`, `prepositions`, `epistemic-conjecture`, `clitic-doubling`, `personal-a`, `gerund-rules`, `adversatives`, `legal-subjunctive`, `verbs-of-becoming`, `epistemic-adverbs`, `possessive-datives`, `corrective-polarity`, `participial-absolutes`, `scalar-concession`.
